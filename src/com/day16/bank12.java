...
public class bank12 {
    ...
    public bank12(String name, int age, String adhar, String phone) {
    ...
    public static void main(String[] args) {
		...
		bank12 obj1 = new bank12();
		System.out.println(obj1.getName());
		
		//still we get blank for this final here.
		bank12 obj = new bank12(obj1.getName(),10, "adhar", "phone"); 
